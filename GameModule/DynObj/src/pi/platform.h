...
//   PFM_BIG_ENDIAN           - If big endian (not currently used)
...
// Helper, Log2 for up to 15 
#define PFM_LOG2(N) (N>7?3:(N>3?2:(N>1?1:0)))
#define PFM_INT_SIZE     PFM_LOG2(sizeof(int))
#define PFM_PTR_SIZE     PFM_LOG2(sizeof(void*))
#define PFM_WCHART_SIZE  PFM_LOG2(sizeof(wchar_t))
