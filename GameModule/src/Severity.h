...
enum Severity
{
	...
	WARNING = 2,		// Bot wants to take action that is not permitted (like checking when calling/raising is possible or talking/expressing emotions/using bot knowledge tables when not possible). These actions are typically ignored.
