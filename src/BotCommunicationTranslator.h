...
private:
	Process* process;
protected:
	virtual void interpret(const char* const msg) = 0;
	virtual void send(bool msg) = 0;
	virtual void send(const Card* const msg) = 0;
	virtual void send(Comment msg) = 0;
	virtual void send(int msg) = 0;
	virtual void send(int msgSize, const int* const msg) = 0;
	virtual void send(const char* const msg) = 0;
public:
	...
	virtual void roundWinners(int numOfWinners, const int* const winners) = 0;
