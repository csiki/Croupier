...
function reset() {
	...
	document.body.style[ 'backgroundColor' ] = "#E5F4FF";
...
function createBall( x, y ) {
    ...
    var img = document.getElementById("chips");
    graphics.drawImage(img, Math.round((Math.random()*2))*100, Math.round((Math.random()*2)) *100, 100, 100, 0, 0, size, size);
