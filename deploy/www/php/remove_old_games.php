...
$oldGames = SQL("SELECT id, log, result FROM games WHERE endTime < ? AND endTime != 0", $date->format("Y-m-d H:i:s"));
SQL("DELETE FROM games WHERE endTime < ? AND endTime != 0", $date->format("Y-m-d H:i:s"));
if($oldGames != null)
